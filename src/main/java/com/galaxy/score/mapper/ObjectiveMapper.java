 ...
 * @Date 2021/3/2 10:30
 */
public interface ObjectiveMapper extends BaseMapper {
    ...
    List<Map<String, Object>> foreAndLiveMonitor(@Param("start") String start, @Param("end") String end,
                                                 @Param("facname") String facname, @Param("tableName") String tableName);

    List<Map<String, Object>> getObtHourCount(@Param("start") Timestamp start, @Param("end") Timestamp end);

    List<Map<String,Object>> getGridHourCount(@Param("start") String start, @Param("end") String end,
                                              @Param("facname") String facname);

    List<Map<String,Object>> getGridDayCount(@Param("start") String start, @Param("end") String end,
                                             @Param("facname") String facname);
